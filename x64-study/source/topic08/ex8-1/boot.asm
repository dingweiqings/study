...
;; ** 实验：将 IVT 表重定位在 600H 位置上 **

        sidt [old_IVT_pointer]                ; 保存原来的 IVT 地址
...
old_IVT_pointer        dw 0                        ; IVT limit
                       dd 0                        ; IVT base
                                
new_IVT_pointer        dw 3FFH                      ; IVT limit
                       dd 0600H                     ; IVT base

msg1 db 'now: IDTR.base = 600H', 13, 10, 0
msg2 db 'now: IDTR.base = 0H', 13, 10, 0
